...
# All the url patterns/paths for register, login, logout, reset-password and profile.
urlpatterns = [
    ...
    path('admin/', admin.site.urls),            # Admin page url pattern
    path('musify/', include('musify.urls')),    # Matches the url patterns from musify application's urls.py file.
